...
// Ordena os produtos pelo preço (que é o segundo elemento da lista)
produtosGamers.sort((a, b) => a[1] - b[1]);

// Seleciona os 3 produtos mais baratos
const produtosMaisBaratos = produtosGamers.slice(0, 3);
